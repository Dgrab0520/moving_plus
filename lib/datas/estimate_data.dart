...
class EstimateData{
  ...
  //견적서 보내기
  static Future<String> insertEstimate(String pro_id, String estimate_id, String order_id, String estimate_price, String estimate_detail) async {
    try{
  ...
  //견적 이력 조회
  static Future<List<Estimate>> getEstimate_record(String order_id, String pro_id) async {
    try{
      var map = Map<String, dynamic>();
