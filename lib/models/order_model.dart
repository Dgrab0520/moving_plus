class Order{
  ...
  factory Order.fromJson(Map<String, dynamic> json){
    return Order(
      ...
      space_type: json['space_type'] == null ? "" : json['space_type'] as String,
      space_size: json['space_size'] == null ? "" : json['space_size'] as String,
      service_type: json['service_type'] == null ? "" : json['service_type'] as String,
      date_start: json['date_start'] == null ? "" : json['date_start'] as String,
      ...
      request_detail: json['request_detail'] == null ? "" : json['request_detail'] as String,
      order_date: json['order_date'] == null ? "" : json['order_date'] as String,
